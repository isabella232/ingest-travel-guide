...
* [4.2 Fastq File Validator](services.md-file-validator)

#### b. Support full metadata validation against metadata specification JSON schema
* [4.1 Metadata Validator/s](services.mdata-validators)

#### c. Support validation of relationships between entities
* [4.1 Metadata Validator/s](services.mdata-validators)
* [2.3 Metadata JSON Collection Validator](services.mdata-json-collection-validator)
...
* [5. Ingest Archiver](services.md-archiver)

#### b.  Assignment of “user-friendly” HCA namespace accessions to relevant entities
* [3.1 HCA Accessioner](services.mdccessioner)
...
* [1. Ingest Broker API](services.md-broker-api)
* [8. Ingest Broker UI](services.md-broker-ui)

#### b. Support ingestion of metadata content via XLSX format spreadsheet upload and include validation reports
* [1.3 Template Spreadsheet Download](services.mdate-spreadsheet-download)
* [1.4 Spreadsheet Upload](services.mddsheet-upload)
* [2.2 Spreadsheet to JSON Converter](services.mddsheet-to-json-converter)

#### c. Interface to add or edit fields that require an ontology terms before completing a submission.
* [8.4 Action: Update Ontology in Sample](services.mdn-update-ontology-in-sample)
...
* [7. Ingest Core](services.md-core)
...
* [6. Ingest Exporter](services.md-exporter)
...
* [6.1. Bundle Generator](services.mde-generator)
